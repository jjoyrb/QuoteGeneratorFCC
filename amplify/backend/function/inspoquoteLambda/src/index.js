...
async function updateQuoteDDBOject(){
    const quoteTableName = process.env.API_INSPIRATIONALQUOTES_QUOTEAPPDATATABLE_NAME;
    const quoteObjectID = "9dc29ac9-1b7d-4b26-b749-e730bb056b3b";
...
exports.handler = async (event) => {
    ...
    async function getRandomQuote(apiURLInput) {
        ...
        //Validate response to the apiURL
        ...
        quoteAuthor =
          quoteData[0].bookname +
          " " +
          quoteData[0].chapter +
          ":" +
          quoteData[0].verse;
        console.log(quoteVerse);
        console.log(quoteReference);
      ...
      */
        ...
        const svgImage = `
              <svg width="${width}" height="${height}">
                  ...
                  <text x="${width / 2}" y="${
          height - 10
        }" class="footerStyles">Developed by @JohnJoy | Quotes from Bible.org</text>
                </svg>
          `;
